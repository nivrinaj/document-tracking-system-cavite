        ...
        View::composer('*', function ($view) {
            try {
                $view->with('settings', [
                    ...
                    'desktop_receive_scope' => Setting::get('desktop_receive_scope', 'all'),
                    'desktop_receive_departments' => Setting::get('desktop_receive_departments', ''),
                    ...
                    'enable_user_delete' => Setting::get('enable_user_delete', '1'),
                ...
                $view->with('settings', [
                    ...
                    'desktop_receive_scope' => 'all',
                    'desktop_receive_departments' => '',
