...
class Department extends Model
{
    ...
    protected $fillable = ['name', 'code', 'description', 'is_active', 'is_accounting', 'deadline_enabled', 'deadline_highlight_rules', 'deadline_overdue_color', 'time_tracking_mode', 'broadcast_ack_layout', 'restricted_doc_types', 'sla_enabled', 'sla_days', 'sla_document_type'];

    protected $casts = ['is_active' => 'boolean', 'is_accounting' => 'boolean', 'deadline_enabled' => 'boolean', 'deadline_highlight_rules' => 'array', 'broadcast_ack_layout' => 'boolean', 'restricted_doc_types' => 'array', 'sla_enabled' => 'boolean', 'sla_document_type' => 'array'];
