...
class Department extends Model
{
    ...
    protected $fillable = ['name', 'code', 'description', 'is_active', 'is_accounting', 'deadline_enabled', 'deadline_highlight_rules', 'deadline_overdue_color', 'deadline_included_statuses', 'time_tracking_mode', 'calendar_days_include_weekends', 'broadcast_ack_layout', 'forward_to_head_enabled', 'restricted_doc_types', 'sla_enabled', 'sla_days', 'sla_document_type'];

    protected $casts = ['is_active' => 'boolean', 'is_accounting' => 'boolean', 'deadline_enabled' => 'boolean', 'deadline_highlight_rules' => 'array', 'deadline_included_statuses' => 'array', 'calendar_days_include_weekends' => 'boolean', 'broadcast_ack_layout' => 'boolean', 'forward_to_head_enabled' => 'boolean', 'restricted_doc_types' => 'array', 'sla_enabled' => 'boolean', 'sla_document_type' => 'array'];
