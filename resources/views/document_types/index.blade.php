<x-app-layout>
    ...
    <div class="space-y-5">
        <div class="flex items-center justify-between gap-3">
            <p class="text-sm text-gray-500 dark:text-gray-400">Document types available when encoding. All are available to every office; limit an office to a subset in Departments → edit.</p>
        ...
        <x-card padding="p-0">
            <table class="r-table min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700/40">
                    <tr><th class="table-th">Name</th><th class="table-th">Voucher field</th><th class="table-th">Status</th><th class="table-th text-right">Action</th></tr>
                </thead>
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    @empty
                        <tr><td colspan="4" class="px-4 py-10 text-center text-sm text-gray-400">No document types yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
