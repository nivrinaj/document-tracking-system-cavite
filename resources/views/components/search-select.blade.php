...
{{-- A searchable single-select. $options: array of ['value','label','group'(optional)].
     The clear ("x") button is a SIBLING of the trigger button, absolutely positioned —
     never nest a <button> inside another <button> (invalid HTML; browsers silently
     break the nested one out of the DOM, which misaligns it). --}}
