<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <x-card>
            ...
            <p class="text-xs text-gray-400 mb-3">The fund code prefixes the auto-generated tracking code. Mark “Dev Fund” for the 20% Development Fund (separate sequence) and “Hospital” for funds the Hospital division may use.</p>
            <div class="overflow-x-auto">
                <table class="r-table min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700/40"><tr>
                        <th class="table-th">Name</th><th class="table-th">Code</th><th class="table-th">Dev</th><th class="table-th">Hospital</th><th class="table-th">Active</th><th class="table-th text-right">Action</th>
                    </tr></thead>
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse($funds as $fund)
                            <tr x-data="{ edit: false }">
                                ...
                                <td class="table-td" data-label="Dev">{!! $fund->is_dev_fund ? '✓' : '<span class="text-gray-300">—</span>' !!}</td>
                                ...
                                <td class="table-td text-right" data-label="Action">
                                    ...
                                    <form x-show="edit" x-cloak method="POST" action="{{ route('accounting.funds.update', $fund) }}" class="mt-2 grid grid-cols-2 gap-2 text-left">
                                        ...
                                        <label class="flex items-center gap-1 text-xs"><input type="hidden" name="is_dev_fund" value="0"><input type="checkbox" name="is_dev_fund" value="1" class="rounded" @checked($fund->is_dev_fund)> Dev Fund (own sequence)</label>
            ...
            <form method="POST" action="{{ route('accounting.funds.store') }}" class="mt-3 grid grid-cols-1 sm:grid-cols-5 gap-2 items-center border-t border-gray-100 dark:border-gray-700 pt-3">
                ...
                <label class="flex items-center gap-1 text-xs"><input type="checkbox" name="is_dev_fund" value="1" class="rounded"> Dev</label>
