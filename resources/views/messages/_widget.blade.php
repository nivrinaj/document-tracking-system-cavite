                ...
                <template x-for="m in messages" :key="m.id">
                    <div class="flex flex-col" :class="m.mine ? 'items-end' : 'items-start'">
                        <div class="px-3 py-1.5 rounded-2xl text-sm leading-snug shadow-sm"
                             ...
                             :style="(m.mine ? 'background: var(--color-primary); ' : '') + 'max-width: 82%; width: fit-content;'">
...
<script>
    function chatWidget() {
        return {
            ...
            activeId: null, title: '', group: false, deptGroup: false, messages: [], body: '', lastId: 0,
            timer: null, idle: 0,
            ...
            async openConversation(id, title) {
                ...
                const d = await r.json();
                this.title = d.title; this.group = d.group; this.deptGroup = d.dept_group; this.messages = d.messages;
